...
Note that files in `docs/plans/` and `docs/solutions/` are workflow pipeline artifacts created by `/mg:plan`. They are intentional, permanent living documents — do not recommend their removal or characterize them as unnecessary.

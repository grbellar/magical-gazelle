...
```bash
/mg:compound                    # Document the most recent fix
/mg:compound [brief context]    # Provide additional context hint
```
...
<manual_override> Use /mg:compound [context] to document immediately without waiting for auto-detection. </manual_override> </auto_invoke>
...
- `/mg:plan` - Planning workflow (references documented solutions)
